...
<Frame>
![Transactions tab showing revenue summary and time filters](/images/transactions-tab-summary.png)
</Frame>
...
<AccordionGroup>
<Accordion title="How much revenue has this client generated?">
1. Click **All Time** at the top
2. Look at the **Revenue** number in the summary

**Example**: "$397.51" means they've paid you nearly $400 total since joining.

**Use case**: Identifying your top-paying clients for VIP treatment or special offers.
</Accordion>
...
|---------------|----------------|
| **Refund a payment** | Main Payments → Transactions → Refund button |
| **Update payment method** | Client must do this in their Portal Settings |
| **Cancel subscription** | Subscriptions tab → Cancel |
| **Retry failed payment** | Main Payments → Subscriptions → Retry |
...
**Track lifetime value (LTV)**: Use "All Time" + Revenue to see total client value. If someone has generated $2,000+ in revenue, they're a VIP—treat them accordingly.
...
<Card title="Payment Settings" icon="credit-card" href="/payments/overview">
