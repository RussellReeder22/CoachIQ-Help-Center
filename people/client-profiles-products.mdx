...
<Frame>
![Products tab showing product cards with filters](/images/products-tab-view.png)
</Frame>
...
| **Refund purchase** | Transactions tab → Refund |
...
**"Load More Products" button**: If client has purchased many products over time, click to load older purchases.
