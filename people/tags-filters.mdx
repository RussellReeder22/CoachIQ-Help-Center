...
<Frame>
  ![Tag sidebar showing All tags, Untagged, and custom tags](/images/people-tag-sidebar.png)
</Frame>
...
<Steps>
  <Step title="Click '+ Create tag'">
    ...
    <Frame>
      ![Create tag button in sidebar](/images/people-create-tag-button.png)
    </Frame>
  </Step>
...
<Steps>
  ...
  <Step title="Find the Tags field">
    ...
    <Frame>
      ![Tags field in User Details sidebar](/images/people-profile-tags-field.png)
    </Frame>
  </Step>
...
<Frame>
  ![Role filter tabs: All, Admins, Coaches, Parents, Athletes, Customers](/images/people-role-filter-tabs.png)
</Frame>
...
<Tabs>
  <Tab title="Find trial athletes ready to convert">
    **Goal**: Message all trial clients who have attended 2+ sessions

    **Filters to use:**

    1. Click **Athletes** role tab
    2. Click "Trial" tag in sidebar
  ...
  <Tab title="Find inactive members">
    ...
    **Filters to use:**
    ...
    1. Click "Active Member" or "Monthly Subscription" tag
    2. Export the list
    3. Cross-reference with Calendar → Recent bookings
...
<Steps>
  ...
  <Step title="Select recipients by tag">
    ...
    <Frame>
      ![Selecting recipients by tag in Inbox](/images/inbox-select-by-tag.png)
    </Frame>
  </Step>
...
**Learn more**: See [Sending Messages](/inbox/sending-messages) for complete Inbox messaging guide.
...
<Steps>
  ...
  <Step title="Click Export button">
    ...
    <Frame>
      ![Export button in Clients list](/images/people-export-button.png)
    </Frame>
  </Step>
...
<AccordionGroup>
  ...
  <Accordion title="What happens if I delete a tag?">
    ...
    - It's removed from all clients who had it
...
<CardGroup cols={2}>
  <Card title="Group Messaging with Tags" icon="messages" href="/inbox/sending-messages">
...
<CardGroup cols={3}>
  ...
  <Card title="Automations" icon="wand-magic-sparkles" href="/tools/automations">
    Auto-tag clients based on actions
  </Card>
  <Card title="Forms" icon="file-lines" href="/tools/forms">
