...
<Frame>
  ![Credits tab showing Logs, Master Credits, and product-specific tabs](/images/credits-tab-subtabs.png)
</Frame>
...
<Frame>
  ![Credit transaction log showing all columns](/images/credits-transaction-log.png)
</Frame>
...
<AccordionGroup>
  ...
  <Accordion title="Manually adding credits (makeup, promotion, gift)">
    **You can't do it from this tab.** To manually add credits:
    ...
    [Learn how to add credits →](/payments/adding-credits)
  </Accordion>
</AccordionGroup>
...
<CardGroup cols={3}>
  ...
  <Card title="Credit System Guide" icon="book" href="/payments/credits-overview">
