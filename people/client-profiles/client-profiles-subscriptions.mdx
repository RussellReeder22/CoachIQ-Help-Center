...
The tab reads **No payment methods on file** until the client has paid once or saved a card through a [card-on-file product](/payments/product-builder#section-2-payment-options). Clients change or add cards themselves from **Billing** in the athlete portal; see [Updating client payment methods](/payments/manage-subscriptions#updating-client-payment-methods).
