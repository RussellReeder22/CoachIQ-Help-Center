...
icon: "photo-film"
keywords: ["media", "shared content", "programs", "lessons", "videos", "client media", "assigned content"]
---
...
<Frame>
![Media Hub showing tag filters and content list](/images/media-hub-example.png)
</Frame>
...
[Learn how to share content →](/content/sharing-programs)
...
<CardGroup cols={3}>
<Card title="Creating Programs" icon="graduation-cap" href="/content/programs-overview">
Build multi-lesson training courses
</Card>

<Card title="Sharing Content" icon="share-nodes" href="/content/sharing-programs">
