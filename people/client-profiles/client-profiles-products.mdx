...
<Warning>
  **Credit-bearing products can't be deleted once their credits have been used.** If you add the wrong credit product and the athlete books with it, you can't remove the product from the profile; instead, turn off its credits from the **Credits** tab. See [Turning off a product's credits](/people/client-profiles/client-profiles-credits#turning-off-a-products-credits).
</Warning>
