...
icon: "user-plus"
keywords: ["add client", "add athlete", "new client", "import clients", "bulk import", "CSV import", "edit client", "update client info", "custom fields"]
---
...
<Steps>
  <Step title="Click 'New User' button">
    ...
    <Frame>
      ![CoachIQ New User button on the Clients page](/images/new-user.png)
    </Frame>
...
<Steps>
  <Step title="Open the client profile">
    ...
    <Frame>
      ![CoachIQ client profile with User Details sidebar](/images/profile-view-default.png)
    </Frame>
  </Step>
...
<CardGroup cols={2}>
  <Card title="Client Profiles Overview" icon="id-card" href="/people/client-profiles/client-profiles">
  ...
  <Card title="Messaging Clients" icon="message" href="/inbox/in-app-messages">
...
<CardGroup cols={3}>
  ...
  <Card title="Credits Management" icon="coins" href="/people/client-profiles/client-profiles-credits">
    View and adjust client credit balances
  </Card>
  <Card title="Connect children" icon="people-group" href="/people/client-profiles/client-profiles#connect-children">
    Connect an athlete or create a managed child from the client Family section
  </Card>
  <Card title="Bulk Operations" icon="list-check" href="/people/tags-filters">
    Update multiple clients at once with tags
  </Card>
  <Card title="Import & Export" icon="arrow-right-arrow-left" href="/settings/index#import-people">
