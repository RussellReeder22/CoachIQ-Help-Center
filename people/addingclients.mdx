...
<Steps>
  <Step title="Click 'New User' button">
    ...
    <Frame>
      ![New User button location in client list](/images/people-new-user-button.png)
    </Frame>
  ...
  <Step title="Assign role(s)">
    ...
    **Common role selections:**
    ...
    - **Customer** - Often selected alongside "Athlete" for paying clients
    - **Parent** - For guardians of youth athletes
    - **Coach** - If they also help deliver training
...
<Steps>
  <Step title="Open the client profile">
    ...
    <Frame>
      ![User Details sidebar showing editable fields](/images/people-profile-user-details.png)
    </Frame>
  </Step>
