...
icon: "credit-card"
keywords: ["accept payments coaching business", "coaching payment processing", "Stripe for coaches", "coaching subscription billing", "refund coaching sessions", "payment processing fees coaching", "sell coaching sessions online"]
---
...
<AccordionGroup>
  ...
  <Accordion title="What are the payment processing fees?" id="processing-fees">
    Stripe charges 2.9% + \$0.30 per successful transaction (US standard rates), and CoachIQ adds 1% + \$0.20 on top — a combined 3.9% + \$0.50 per transaction. You can choose to absorb the combined fee yourself or pass it to the client at checkout.
...
<AccordionGroup>
  ...
  <Accordion title="Can I require a waiver or terms acceptance at checkout?" id="terms-waivers">
    ...
    [Add terms and waivers at checkout](/tools/waivers/waivers)
  </Accordion>
