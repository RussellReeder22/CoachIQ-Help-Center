...
<AccordionGroup>
  ...
  <Accordion title="How do I set my availability for sessions?" id="set-availability">
    ...
    [Learn how availability works](/scheduling/how-availability-works)
  </Accordion>
  ...
  <Accordion title="Does CoachIQ sync with Google Calendar?" id="google-calendar">
    Yes. Connect your Google Calendar so your CoachIQ bookings automatically appear on your personal calendar. Sync is one-way (CoachIQ → Google Calendar): bookings you take in CoachIQ show up on Google, but edits or deletions you make in Google Calendar do not update CoachIQ. Always manage your schedule from CoachIQ.
  ...
  <Accordion title="What happens if two athletes try to book the same time slot?" id="double-booking">
    CoachIQ prevents double-booking automatically. Once a time slot is taken, it's removed from your available times. Note that CoachIQ does not read your Google Calendar, so personal events there won't block off availability in CoachIQ. Your open times are controlled entirely by your CoachIQ availability schedule and blackout dates.
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion title="How does the credit system work with scheduling?" id="credits-scheduling">
    ...
    [Credit system overview](/payments/credits/credit-system-overview)
  </Accordion>
