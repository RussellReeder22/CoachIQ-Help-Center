...
Forms can trigger [automations](/automations/what-are-automations) when submitted — sending messages, adding tags, or assigning credits automatically.
...
<Steps>
  <Step title="Go to Automations">
    Navigate to [**Tools → Automations**](/automations/what-are-automations).
  </Step>
...
<CardGroup cols={2}>
  ...
  <Card title="Build Your First Automation" icon="bolt" href="/automations/build-your-first-automation">
