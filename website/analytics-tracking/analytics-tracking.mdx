...
<Frame>
  ![CoachIQ Scripts and Analytics settings location in the sidebar](/images/acceswebscripts.png)
</Frame>
...
<Steps>
  ...
  <Step title="Open Settings panel">
    ...
    <Frame>
      ![Navigating to Scripts and Analytics in CoachIQ Website Builder sidebar](/images/acceswebscripts.png)
    </Frame>
  </Step>
  <Step title="View the Scripts & Analytics modal">
    ...
    <Frame>
      ![CoachIQ Scripts and Analytics modal with Google Analytics and Facebook Pixel fields](/images/scriptsscreen.png)
    </Frame>
  </Step>
</Steps>
