...
Your Google Analytics 4 Measurement ID will appear at the top of the page.
...
<CardGroup cols={2}>
<Card title="Set conversion goals" icon="target">
...
<Note>
**Need help?** Join our [Office Hours](https://coachiq.com/office-hours) for live Google Analytics setup assistance.
</Note>
