...
## Set metadata when creating a page

The new-page dialog includes **Meta Title** and **Meta Description**, so you can enter search-result copy while creating the page. You can update those values later in the page settings using the steps below.
