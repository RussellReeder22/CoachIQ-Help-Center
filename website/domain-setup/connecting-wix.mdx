...
<Steps>
  ...
  <Step title="Click Invite Collaborators">
    ...
    <Frame>
      ![Wix Roles and Permissions settings page with Invite Collaborators button](/images/role&permissionswix.png)
    </Frame>
  </Step>
  <Step title="Add CoachIQ support">
    ...
    <Frame>
      ![Wix invite collaborator form with CoachIQ email and Co-owner role selected](/images/wixinvitesitecollaborators.png)
    </Frame>
    <Note>
