...
![CoachIQ Website Builder Settings panel in the left sidebar](/images/globalwebsitesettings.png)
...
![CoachIQ Design settings option in the Website Builder sidebar](/images/designsettings.png)
...
![CoachIQ global design settings with theme selector, font, and color options](/images/gloabldesignsettings.png)
...
### How custom sections use Design settings

Custom and AI-generated sections use your site's Design settings as their default styling. Update the site theme, fonts, and colors here to keep pages consistent. A style set explicitly on an individual section overrides its inherited default; check the section's settings if it does not follow a sitewide change.

Preview and publish after changing styles, then check the live page on desktop and a phone.
