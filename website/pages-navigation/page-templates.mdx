...
<Frame>
  ![CoachIQ Add New Page dialog showing the page template dropdown options](/images/builder-templates.png)
</Frame>

_The "Add New Page" dialog box showing the template dropdown with all available options_
...
<Steps>
  <Step title="Access the page creation dialog">
    ...
    <Frame>
      ![CoachIQ Website Builder left sidebar with Add New Page button highlighted](/images/add-new-page.png)
    </Frame>
    _Left sidebar with "Add New Page" button clearly highlighted_
  </Step>
...
<Frame>
  <video controls className="w-full aspect-video rounded-xl" src="/videos/page-templates-walkthrough.mp4" />
</Frame>
...
<Steps>
  <Step title="Review the generated sections">
    ...
    <Frame>
      ![CoachIQ Privacy Policy template with generated sections for customization](/images/privacy-policy-template.png)
    </Frame>
  </Step>
...
<Steps>
  ...
  <Step title="Access footer navigation">
    ...
    <Frame>
      ![CoachIQ Website Builder footer section with navigation link settings](/images/footer-location.png)
    </Frame>
  </Step>
...
<CardGroup cols={2}>
  <Card title="Learn About Page Sections" icon="book" href="/website/sections/sections">
    Understand how to customize and modify sections within your template pages
  </Card>
  <Card title="Website Navigation" icon="sitemap" href="/website/pages-navigation/pages-navigation">
