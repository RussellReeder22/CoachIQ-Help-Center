...
<Steps>
  <Step title="Access the templates">
    ...
    <Frame>
      ![CoachIQ Website Builder Add New Page button with template options](/images/add-new-page.png)
    </Frame>
  </Step>
...
<Steps>
  <Step title="Follow the same process">
    ...
    <Frame>
      ![CoachIQ Terms and Conditions page template selected in the template picker](/images/terms-conditions-template1.png)
    </Frame>
  </Step>
...
<Steps>
  ...
  <Step title="Add to footer navigation">
    ...
    <Frame>
      ![CoachIQ website footer navigation with legal page links added](/images/terms-footer.png)
    </Frame>
  </Step>
...
- [URL Slugs & Page Management](/website/pages-navigation/url-slugs-page-management) - Customize your legal page URLs
