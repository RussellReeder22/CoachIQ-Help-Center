---
title: "Buttons and Call-to-Actions"
...
sidebarTitle: "Buttons & CTAs"
icon: "square-arrow-up-right"
keywords: ["section buttons", "call-to-action buttons", "website buttons", "CTA optimization", "coaching website conversions"]
---
...
<Steps>
  ...
  <Step title="Locate the Buttons panel">
    ...
    <Frame>
      ![Section buttons management panel](/images/buttons.png)
    </Frame>
  </Step>
...
<Steps>
  <Step title="Access button destination options">
    ...
    <Frame>
      ![CoachIQ button destination options including page, form, product, and session links](/images/button-options.png)
    </Frame>
  </Step>
...
- [Forms Integration](/tools/forms/overview) - Set up forms to use as button destinations