---
title: "Section Styling and Layout - CoachIQ Website Builder"
...
keywords: "CoachIQ section styling, website section backgrounds, section layout customization, website builder styling, coaching website design"
---
...
In the section settings panel, locate the **Background** controls.

<Frame>
<img src="/images/section-background-controls.png" alt="Section background settings panel" />
</Frame>
</Step>
...
In your selected section's settings panel, find the **Vertical Padding** slider.
</Step>
...
Look for the **Width (Default)** setting in your section panel.
</Step>
...
Temporarily hide the visual styling of a section while keeping the content.

<Steps>
<Step title="Locate Hide Styles toggle">
In your section settings, find the **Hide Styles** toggle switch.
</Step>

<Step title="Toggle styling on or off">
Switch the toggle to hide or show the section's styling:

- **Toggle ON**: Section content remains but styling is hidden
- **Toggle OFF**: Section displays with all styling applied

<Note>
This is useful for testing how sections look with and without custom styling, or for temporarily simplifying your design.
</Note>
</Step>
</Steps>
...
<Accordion title="What's the difference between hiding a section and hiding styles?">
Hiding a section removes it completely from your live site. Hiding styles keeps the section visible but removes the visual styling (background, colors, etc.).
</Accordion>
