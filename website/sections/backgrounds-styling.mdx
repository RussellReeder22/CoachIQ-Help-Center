...
<Frame>
  ![CoachIQ Website Builder section styling panel with background and spacing options](/images/background-settings-full-page.png)
</Frame>
...
<Steps>
  ...
  <Step title="Access background options">
    ...
    <Frame>
      ![Background Toggle](/images/background-toggle.png)
    </Frame>
  </Step>
  <Step title="Choose your background type">
    ...
    <Frame>
      ![CoachIQ section background options showing color, image, and no background choices](/images/background-settings.png)
    </Frame>
    <Tip>
...
- [Editing Section Content](/website/sections/working-with-sections) - Customize the text, images, and content within sections
