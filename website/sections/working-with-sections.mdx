---
title: "Add and Manage Website Sections"
...
keywords: "add website sections CoachIQ, manage sections, reorder sections, website builder sections, CoachIQ section management"
---
...
<Steps>
  ...
  <Step title="Use the section controls">
    Look for the reorder controls (usually arrows or a move handle) next to the section name in the left sidebar.
  ...
  <Step title="Move to desired position">
    Use the controls to move the section up or down to your preferred position.
