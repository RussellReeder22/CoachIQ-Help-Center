---
title: "Website Pages & Navigation Setup - CoachIQ Help"
...
<Frame>
<img src="/images/website-page-hierarchy-example.png" alt="Example of coaching website page hierarchy showing Training Programs with subpages" />
</Frame>
*Screenshot Note: Diagram or visual showing a typical coaching website structure (Home → About → Training Programs → In-Person Training, Online Training)*
...
From your CoachIQ dashboard, click **Website Builder** to access your site management tools.

<Frame>
<img src="/images/dashboard-website-builder-navigation.png" alt="CoachIQ dashboard highlighting Website Builder menu item" />
</Frame>
*Screenshot Note: Dashboard view with Website Builder highlighted in navigation*
</Step>
...
<Frame>
<img src="/images/website-pages-sidebar.png" alt="Website Builder sidebar showing expanded Pages section" />
</Frame>
*Screenshot Note: Left sidebar with Pages section expanded showing Home, About, Training Programs, etc.*
...
<Frame>
<img src="/images/add-new-page-button.png" alt="Add New Page button in Website Builder sidebar" />
</Frame>
*Screenshot Note: Close-up of the "Add New Page" button in the sidebar*
</Step>
...
<Frame>
<img src="/images/new-page-dialog-filled.png" alt="New Page dialog showing filled form fields for coaching page" />
</Frame>
*Screenshot Note: The "New Page" modal with example coaching content filled in (like "Basketball Skills Training")*
...
Here's the corrected markdown from line 167 onwards in proper formatting:
markdownMany coaches benefit from organizing services into logical groups. Here's how to structure your offerings:
...
<Frame>
<img src="/images/parent-page-creation.png" alt="Creating Training Programs parent page in CoachIQ" />
</Frame>
*Screenshot Note: New page dialog configured for creating "Training Programs" parent page*
</Step>
...
<Frame>
<img src="/images/subpages-hierarchy.png" alt="Website Builder showing completed page hierarchy with subpages" />
</Frame>
*Screenshot Note: Left sidebar showing the complete hierarchy with Training Programs expanded to show all subpages*
</Step>
</Steps>
...
<Frame>
<img src="/images/header-navigation-access.png" alt="Accessing header navigation settings in Website Builder" />
</Frame>
*Screenshot Note: Website Builder interface showing how to access header/navigation settings*
...
<Frame>
<img src="/images/header-navigation-setup.png" alt="Header navigation configuration showing main menu items" />
</Frame>
*Screenshot Note: Navigation setup interface with main menu items being configured*
...
<Frame>
<img src="/images/footer-navigation-setup.png" alt="Footer navigation configuration interface" />
</Frame>
*Screenshot Note: Footer settings showing navigation links, contact info, and social media options*
</Step>
