...
**Where to find this**: Click **Settings** in the bottom-left corner of your dashboard. The **General** section is the first group in the Settings menu: **Account**, **Organization**, **Groups**, **Blocklist**, and **Connections**.
...
Manage Stripe and Google Calendar, open the ChatGPT connection guidance, and see which integrations are still upcoming. See [Manage your connections](/settings/connections).
