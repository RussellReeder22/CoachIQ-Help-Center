...
<Tip>
  **Digitize your onboarding paperwork**: Use CoachIQ Forms to collect emergency contacts, direct deposit info, and signed agreements. See [Creating Forms](/forms/creating-forms) to set up your new hire intake form.
</Tip>
...
<Tip>
  **Automate reminders**: Set up a scheduled automation to remind yourself about weekly trainer check-ins. See [Scheduled Automations](/automations/scheduled-automations).
</Tip>
