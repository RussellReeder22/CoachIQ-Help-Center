...
<AccordionGroup>
  ...
  <Accordion title="Should I pay for Google Ads?">
    Your Business Profile is free and should be optimized first. Once you're getting consistent organic results, paid ads can amplify your reach—especially for competitive keywords or seasonal camps. Start organic, add paid when you're ready to scale. If you'd rather not run ads yourself, see the [Done-For-You Paid Ads power-up](/power-ups/done-for-you-paid-ads).
  </Accordion>
