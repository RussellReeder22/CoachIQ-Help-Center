...
Jeff Schmidt at Schmidt Performance in Northern Colorado has seven coaches, two gyms, and a goal of 120 members. He's never spent a dollar on ads. His summary of where the business stands is the one almost every facility owner eventually says out loud: "I have the coaches. I have the gyms. I just need the clients now." This guide is for that moment.
...
<Info>
**Why local search is the whole game for coaches:**

- Parents search with a place attached: "near me," a city, a suburb. Almost nobody searches for a coach without one.
- The map results sit above the regular results on a phone. Most parents never scroll past them.
- Reviews are read before anyone calls. A parent picking between two facilities picks the one other parents vouch for.
- Facility owners in the CoachIQ community consistently name Google as their top source of new families after word of mouth.
</Info>
...
<Info>
**The reality**: Parents look up the facility on Google Maps before they ever open your website. Without a Google Business Profile, you're invisible at the exact moment they're deciding who to call.
</Info>
...
<Steps>
  ...
  <Step title="Add Photos">
    Profiles with real photos get more calls and direction requests than profiles without them. Parents want to see the space their kid will train in.
...
<Tip>
**The secret weapon**: Most coaches set up Google Business Profile once and forget it. A profile that posts weekly, answers reviews, and adds photos looks alive to Google and to parents. In most local markets that alone puts you ahead of the facilities that never touch theirs.
</Tip>
...
<Info>
**The math**: A facility with 50 reviews averaging 4.5 stars will almost always outrank one with 5 reviews averaging 5 stars. Volume and recency matter more than a perfect score.
</Info>
...
<Tabs>
  ...
  <Tab title="Automated">
    Build a CoachIQ automation on the **booking ended** trigger and add the condition that skips the athlete's first booking ever, so the ask lands after they've come back, not after the trial:
...
<Note>
**Set up automated review requests**: The booking-ended trigger is the one to use for any "after the session" follow-up. See the [Triggers & Actions Reference](/tools/automations/triggers-actions-reference) for the trigger and the conditions you can add to it.
</Note>
...
A parent trusts another parent's post far more than anything you publish. When athletes and parents post about training, you get:
...
<Tip>
**Make the lead form ask enough to act on.** Jeff Schmidt gets a lead or two a week he can't do anything with: "I don't know what to do with it because I don't know if it's the athlete, the parent. I don't know if they're in Georgia or if they're in Colorado." Your inquiry form needs, at minimum, who's filling it out, the athlete's age, and the city. Three fields is the difference between a lead and a mystery.
</Tip>
...
<AccordionGroup>
  ...
  <Accordion title="What's more important—website SEO or Google Business Profile?">
    Google Business Profile drives more immediate local traffic. Website SEO provides long-term authority. Do both, but prioritize your Business Profile if you must choose. CoachIQ handles the technical side of website SEO, so your time goes to the profile.
  </Accordion>

  <Accordion title="Should I pay for ads?">
    Your Business Profile is free and should be optimized first. Once you're getting consistent organic results, paid ads can amplify your reach—especially for competitive keywords or seasonal camps. Start organic, add paid when you're ready to scale.

    When you do, the ad is the easy part. Coach Stefano Soccer ran a Facebook campaign that delivered 662 clicks at 25 cents each, then converted 3% of them. The team's own diagnosis: "It should be closer to 20%. So there's something when people land on our landing page here that is throwing them off." The fix they landed on applies to every coach: "I think there was too much information on the landing page. I think the landing page needs to be, hey, five-star reviews, trust us, no commitment, come try it out. Simple as that." One offer, your reviews, one button.

    If you'd rather not run ads yourself, see the [Done-For-You Paid Ads power-up](/power-ups/done-for-you-paid-ads).
  </Accordion>

  <Accordion title="How do I compete with established coaches who have more reviews?">
    Focus on what you can control: post weekly on your Business Profile, respond to every review, upload fresh photos, and keep NAP consistent. Newer businesses regularly outrank established ones whose profiles have gone quiet.
  </Accordion>
