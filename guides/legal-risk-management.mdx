...
The day you sign a lease, you stop being a coach with a side business and become an owner with something to lose. Four things protect it. None of them is expensive next to what they prevent.

<CardGroup cols={2}>
  <Card title="Form an LLC" icon="building">
    Before the lease, before the first client. \$100-500.
  </Card>
  <Card title="Insure before you open" icon="shield-halved">
    General liability at minimum. \$5,000-8,000 a year for the full set.
  </Card>
  <Card title="Every athlete signs a waiver" icon="file-signature">
    Attorney-reviewed for your state, collected at checkout so nobody slips through.
  </Card>
  <Card title="Write it down" icon="clipboard-list">
    Incidents, policies, agreements. If it isn't documented, it didn't happen.
  </Card>
</CardGroup>

<Warning>
  **This is not legal, tax, or insurance advice.** Requirements vary by state and by facility. Use this guide to know what to ask for, then have a licensed attorney, an insurance broker who knows sports facilities, and a CPA confirm the specifics. CoachIQ and the authors assume no liability for decisions made from it.
</Warning>

## Who This Guide Is For

The coach opening or already running a physical training facility. If you're still renting gym time by the hour, Parts 1 through 3 (structure, insurance, waivers) apply to you today. The rest becomes urgent the day you have keys.
...
<Accordion title="Real-world example: when the S-Corp makes sense">
  Elite Baseball and Softball Training outside Grand Rapids runs as an S-Corp. With a 49,000 square foot building, seven to ten full-time coaches on payroll, a pro shop, and travel teams, the payroll infrastructure the S-Corp requires already exists, so the tax election is nearly free to maintain. Brandon's single-owner Indiana LLC is the right call for the same reason in reverse. Match the structure to the payroll you actually run.
</Accordion>
...
<Accordion title="Real-world example: Pro Standard's approach">
  Brandon's part-time coaches are W-2 employees who work scheduled shifts under direct supervision, and his workers compensation policy covers them for approximately \$2,000-3,000 annually. He initially brought his general manager on as a 1099 contractor. That is the arrangement employment attorneys flag most often for facilities, because a manager you direct day to day generally meets the test for an employee regardless of the paperwork. Have your attorney review any manager or coach you plan to treat as a contractor; see the [Hiring & Onboarding Trainers guide](/guides/hiring-onboarding-trainers#legal-foundations-w-2-vs-1099).
</Accordion>
...
- [CoachIQ Waivers](/tools/waivers/waivers): attach the waiver to your products so nobody can buy a package, membership, or camp spot without agreeing, and add it to any registration form
- Dedicated waiver platforms (WaiverSign, Smartwaiver)
- Electronic signature tools (DocuSign, Dropbox Sign)

John Jeffus, co-founder of Futbol Factory in Nashville, on why the waiver lives in the same system as everything else: "It helps us with our communication with parents, our calendars, all of our payments, all of our waivers, and we do online programs with it as well. It's a great resource to have everything all in one place." The point isn't convenience. It's that a waiver stored next to the booking and the payment is one you can find the day you need it.
...
<Accordion title="Real-world example: CoachIQ integration">
  Brandon attaches his waiver to every product in CoachIQ, so a parent can't buy a package, membership, or camp registration without checking "I agree" at checkout. The acceptance is recorded on the client's profile and the compliance report shows who has and hasn't accepted. One signature covers all future participation, so there's no annual renewal chase for families or staff.
</Accordion>
...
"Cancellations require 2+ hours advance notice. Late cancellations (less than 2 hours) forfeit the session credit. No-shows forfeit the session with no credit or refund. Monthly memberships are non-refundable. Members may cancel with 7 days notice before their next billing date and rejoin at the current rate."

<Note>
  **Before you promise a pause option**: CoachIQ subscriptions don't have a built-in pause. If you want to offer one, decide how you'll handle it first (cancel and re-subscribe, or pause collection in Stripe) so the policy you publish is one you can actually run. See [Managing Subscriptions](/payments/manage-subscriptions).
</Note>
...
<Accordion title="Real-world example: Pro Standard's policies">
  ...
  The policy only works because the reminder does the enforcing. Every athlete gets a text a few hours before the session with a reschedule link in it. "Before, every coach has had that text: 'Hey coach, we're not going to be there. Sorry, can we reschedule?' We don't get that anymore. Ever." A cancellation window nobody knows about is a fee you'll end up waiving.
</Accordion>

<Accordion title="Real-world example: Elite's team-fee policy">
  Elite Baseball and Softball Training collects travel-team packages of \$750 to \$1,450 either paid in full or in four monthly payments from August to November. The policy is one line: non-refundable except for a verified season-ending injury. It's specific enough that nobody has to interpret it, and humane enough that nobody resents it.
</Accordion>
...
The most common "knowing agreement" failure in a training facility isn't the waiver. It's the subscription. Coach Stefano Soccer had parents buy a membership twice and then dispute the second charge: "well, I didn't know it's a subscription." If the recurring nature of the charge isn't obvious at checkout, you'll be issuing refunds to people who technically agreed.
...
<Warning>
  **Keep it confidential.** A training facility isn't a medical provider, so HIPAA generally doesn't apply to you, but state privacy laws and basic duty of care do. Limit access to the staff who need it for safety, store paper forms in a locked cabinet, and keep digital records in a password-protected system. Never discuss an athlete's condition with another family.
</Warning>
...
**Digital Tracking**: Check athletes in on the booking when they arrive. CoachIQ stamps the time on the booking and the client profile, which gives you a record of who was in the building for every session. See [Checking In Athletes](/scheduling/checking-in-athletes).
...
<Accordion title="Real-world example: Pro Standard's child safety">
  Brandon requires background checks for every staff member before they work with athletes. The facility has security cameras throughout, which serve as both a safety tool and a deterrent. Coaches check athletes in on each booking in CoachIQ, so there's a timestamped record of who trained when.
</Accordion>

### Staff Classification

Whether a coach is a W-2 employee or a 1099 contractor decides your payroll tax, workers comp, and unemployment obligations, and it's the area where facilities most often get it wrong. The short version: most coaches who work your schedule and teach your methods are employees, and so is a manager you direct. The contractor model can be done properly: Schmidt Performance's coaches are 1099 contractors who each carry their own LLC and their own insurance, which is exactly the profile the tests look for. The [Hiring & Onboarding Trainers guide](/guides/hiring-onboarding-trainers#legal-foundations-w-2-vs-1099) covers the tests, the penalties, and how to structure pay for each.
...
1. **Before opening**: Form the LLC, get insured, get the waiver reviewed, have the lease reviewed
2. **First 30 days**: Waiver on every product, medical info collected, daily checklist running, staff trained on emergencies
3. **Ongoing**: Document every incident, maintain equipment, enforce policies consistently
4. **Annually**: Review coverage as you grow, refresh documents, re-run the emergency drill

Legal protection isn't paranoia. It's what lets you coach without thinking about it. Follow the framework, adapt it to your state, and get the professionals to confirm the specifics.

---

*Last reviewed: September 2026. Laws and requirements change; verify current rules in your state before acting.*
