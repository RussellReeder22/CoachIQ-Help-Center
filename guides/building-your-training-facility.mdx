...
{/* 📸 PHOTO: AI search results screenshot - "Using AI tools like Perplexity accelerates competitor research from 20 hours to 2 hours—here's a search for 'basketball training facilities in Fort Wayne'" [Place after "Modern AI Acceleration" section] */}
...
{/* 📸 PHOTO: Census.gov demographic data screenshot - "Key demographics Brandon researched: Fort Wayne metro 250K+ population, median household income \$55K, 35K youth aged 7-18" [Place after "Data Sources" section] */}
...
{/* 📸 PHOTO: Google Maps with competitor locations marked - "Mapping Brandon's 10-15 competitors across Fort Wayne revealed downtown as the geographic center with equal access from all neighborhoods" [Place after "Location Strategy Considerations" section] */}

{/* 📸 PHOTO: Google Maps drive time radius - "15-minute drive time radius from downtown Fort Wayne covers 80% of target neighborhoods—the sweet spot for facility accessibility" [Place after geographic analysis case study below] */}
...
{/* 📊 PHOTO: Cost breakdown pie chart - Interactive visual showing Brandon's \$70K investment breakdown: Flooring \$40-50K, Equipment \$6K, Improvements \$4K, Deposits \$6K, Technology \$2K, Supplies \$1.5K, Marketing \$2.5K [Place after "Marketing Launch" section] */}
...
{/* 📸 PHOTO: Brandon's facility transformation - Before/after photo series showing warehouse transformation, floor installation process, and final setup with court markings [Place after "Key Success Factors" section] */}
...
{/* 📸 PHOTO: LoopNet.com search results - "LoopNet search filtered for warehouses, 3,000-7,000 sq ft, \$4-8/sq ft in Fort Wayne—narrowing 200+ listings to 15 viable options" [Place after "Online Platforms" section] */}
