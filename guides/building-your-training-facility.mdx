---
title: "How to Find and Lease a Training Facility: Complete Guide for Coaches"
description: "How to go from renting gym time to your own training facility: prove demand first, real costs, the 8-12 month search, and lease negotiation. Built on one owner's real numbers."
sidebarTitle: "Finding Your Facility Location"
icon: "map-location-dot"
keywords: ["how to open a gym", "training facility location", "sports training facility", "gym lease negotiation", "open training facility", "fitness facility guide", "sports facility owner", "baseball training facility", "basketball training facility", "youth sports facility location", "private sports training facility"]
---
...
**Who This Is For**: The coach renting church gyms, school courts, or hourly cages who is ready for a building with their name on the door. Whatever the sport, the lease is the same decision. Most facility owners in the CoachIQ community made this exact transition, and their goal going in was almost always the same: stop depending on someone else's gym.
...
What started as small group sessions under "Brandon Evans Basketball" has evolved into a 4,700 sq ft facility where 40 to 60 athletes train every week. Brandon's journey from church gyms to his own facility embodies every principle in this guide: he proved demand first, researched exhaustively, budgeted conservatively, and learned expensive lessons so you don't have to.
...
<Card title="Economic Distress" icon="arrow-trend-down" iconType="solid">
...
**Start smaller than you think**: Lee Taft, the speed coach who has since consulted for nine NBA teams, opened his first facility at 4,000 square feet with no business background and a rent that jumped after six months. It closed. He went back to teaching, trained about 40 athletes on the side, and when he finally resigned he opened in a 1,000 square foot space. Within a year he had about 150 athletes. He outgrew that into 3,200 square feet, then 6,000, hiring staff along the way. The model was proven at 1,000 square feet. The 4,000 square foot building only proved he wasn't ready for it.

</Info>

<Note>

**The building is what makes it a full-time business**: Jesse Armitstead runs ICE Basketball out of two Utah locations and puts it plainly: "CoachIQ has been one of the biggest reasons why I've been able to grow my business and get to a point where I can support my family full-time and make enough money to do that." The systems and the space arrive together. Get the systems running in the rented gym so the space doesn't have to carry both.

</Note>

<Note>

**Run the rented-space business like a facility already**: The families you're training in the church gym are the ones who move into the building with you. Put them on memberships with a card on file, let them book their own sessions, and give them a real website to send friends to. When you open, day one is a transfer, not a launch. Start with the [First Week Setup Checklist](/quick-guides/first-week-setup-checklist) and the [Website Builder](/website/overview).
...
**Brandon's Location Strategy**: Brandon chose downtown Fort Wayne even though his wealthiest clients lived in the Southwest and North suburbs. Downtown gave equal access from every part of town (families who won't cross the city to a rival neighborhood will come to the middle), the lowest rent (\$4/sq ft vs. \$8-12/sq ft in the suburbs), and room to prove the model. Moving closer to the wealthiest demographic later, once the concept was proven, was an option he earned rather than a bet he made.
...
This number can vary GREATLY depending on your size and buildout preferences. Facilities in the CoachIQ community run from a 1,000 square foot room to Mad Apple Softball's Fort Wayne building with three hitting lanes, three pitching lanes, and a full indoor field, to Elite Baseball and Softball Training's 49,000 square feet outside Grand Rapids: two indoor turf fields, three bullpen lanes, three private HitTrax cages, six team cages, and a weight room, run by a staff of seven to ten full-time coaches. The ranges below are for the first building most coaches sign for, not for Elite.

<Tip>

**Plan for the dead hours before you sign.** A building that size only works if it earns money when your own athletes aren't in it. Elite's plan is to rent the whole facility to high school and college programs in winter and early spring, sell cage memberships on 3-, 6-, and 12-month terms, and run its travel-team practices on Saturdays and Sundays as one hour of field plus one hour of cages. Every square foot has a second job. Sketch that schedule for any space you're considering, and if you can't fill the weekday mornings, lease less.
...
**The \$30,000 mistake**: One contractor, two weeks of pressure to open, and Brandon spent \$40K on flooring that should have cost \$10K. It's the single most expensive error in this guide and the easiest to avoid.

**How to avoid it**: Start pricing flooring the day you sign your lease. Get quotes from commercial flooring companies, used-flooring marketplaces (Facebook, OfferUp), your landlord's contractor referrals, neighboring facilities, and online suppliers who ship. Then give yourself three months. Rushing a major purchase under time pressure always costs more.
...
<Card title="Safety & Comfort" icon="shield-halved">
...
**One subscription instead of a stack**: Most coaches arrive at a facility running a scheduling app, a payment app, a website builder, and a spreadsheet, each with its own bill and none of them talking to each other. CoachIQ replaces that stack with one platform: scheduling, payments and memberships, website, messaging, forms, and the athlete app. Budget one software line, not five. See the [Help Center home](/) for what's included.
...
**Rent is fixed. Make revenue fixed too.** A \$1,900 rent check on the first of the month cannot be paid with drop-in sessions and Venmo requests. Facilities that survive the first year run on memberships: a card on file, billed monthly, with credits the athlete books against. That's the number you forecast from, and the number that builds your 6-12 month reserve. See [Recurring Credit Memberships](/payments/credits/recurring-credit-memberships) and the [Pricing Your Services guide](/guides/pricing-your-services).
...
- **Technology: \$2K**
  ...
  - WiFi and networking: \$500
  - Website and booking software: no setup cost; CoachIQ is in the monthly software line below
...
- Escalation clauses? (Lee Taft's first lease had a low rate that lasted six months, then jumped "right back up to where it was and beyond." The facility didn't survive it. Ask exactly when and by how much the rent changes.)
...
<Card title="Maintenance History" icon="screwdriver-wrench">
...
**A second location is a second business.** Two owners in the CoachIQ community added a location this year and both did it on reliable access to someone else's space rather than a second lease. Coach Stefano Soccer runs Freehold and Middletown, New Jersey, and the first problem wasn't rent, it was seeing both schedules at once from a phone. Jeff Schmidt at Schmidt Performance added a second gym and immediately named the constraint: "managing staff across two locations; ensuring enough staff to cover sessions at both places." His own ceiling is deliberate: "not looking to expand and become like Schmidt Performance Worldwide... stay in a good place where I feel comfortable." Decide what size of business you actually want before the square footage decides it for you.
...
Don't cheap out on flooring quality, insurance, or marketing. Buy them carefully, not cheaply. Those create bigger long-term problems than they save.
...
**Brandon's one-line lesson**: "Get 3-5 quotes and give yourself 3 months. Don't rush major purchases." His flooring decision cost more than every other buildout expense combined.
...
[Book a demo](https://www.coachiq.io/demos/)
...
<Card title="See CoachIQ in Action" icon="video" href="https://www.coachiq.io/demos/">
...
Lease signed? The LLC, insurance, and waiver come before the first athlete walks in.
