...
<Info>
  **Where to find this**: the **Copilot** panel inside the availability and booking builders.
</Info>
...
The main dashboard no longer has a Copilot prompt bar. Open the relevant builder to use Copilot.
...
<CardGroup cols={2}>
  <Card title="Your Dashboard" icon="gauge" href="/getting-started/dashboard">
    Website, athlete portal, and activity shortcuts
  </Card>
