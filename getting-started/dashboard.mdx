...
The dashboard focuses on Website/App controls and activity. The main Copilot prompt bar has been removed; [Copilot](/getting-started/copilot) remains available inside the availability and booking builders.
