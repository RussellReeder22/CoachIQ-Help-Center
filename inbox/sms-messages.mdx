...
SMS is billed in credits. Each message uses 1 credit, whether it's sent or received.

- **1 credit = 1 message** (both sent and received)
- **100 credits = \$1**, so 100 messages cost about \$1
- **Example costs**:
...
- Each segment counts as a separate message (1 credit) for billing
...
- Reply costs apply (1 credit per inbound message)
