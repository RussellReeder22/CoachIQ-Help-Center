...
- Cost: 1 credit per message sent or received (100 credits = \$1)
...
- This is a single email, not an email-marketing campaign. For sequences, lists, and open tracking, use [Email Marketing Campaigns](/inbox/email-marketing)

## Key Inbox features

<Steps>
  <Step title="Unified conversation view">
    All message types appear in one place, with tabs to filter by type (All, Unread, Announcements, In-App, SMS).
  </Step>
...
<Note>
  **SMS costs apply**: Each SMS message (sent or received) uses 1 credit, and 100 credits = $1. Mass texts to 100 athletes = 100 credits (about $1).
</Note>
