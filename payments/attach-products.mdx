...
icon: "link"
keywords: ["attach product", "link product", "product to scheduler", "product to program", "product to form", "accept payment"]
---
...
<Steps>
  <Step title="Navigate to scheduler payment settings">
    ...
    <Frame>
      ![CoachIQ scheduler payment settings section with payment method options](/images/payment-section-scheduler-settings.png)
    </Frame>
  </Step>
...
<Steps>
  <Step title="Client selects session">
    ...
    <Frame>
      ![Athlete view of a CoachIQ scheduler booking page](/images/scheduler-athlete-view.png)
    </Frame>
  </Step>
...
<Steps>
  <Step title="Navigate to program paywall settings">
    ...
    <Frame>
      ![CoachIQ program share settings with paywall toggle](/images/access-paywall-programs.png)
    </Frame>
  </Step>
...
<Steps>
  ...
  <Step title="Payment screen appears">
    ...
    <Frame>
      ![Client checkout screen for a paywalled CoachIQ program](/images/paywalled-program-ui.png)
    </Frame>
  </Step>
...
<Steps>
  ...
  <Step title="Configure payment field">
    **Select product:** Choose which product to connect
    ...
    <Frame>
      ![CoachIQ form builder connections panel with product attached](/images/connected-products-forms.png)
    </Frame>
  </Step>
...
<Steps>
  <Step title="Client fills out form">
    ...
    <Frame>
      ![Client filling out a CoachIQ form with payment field](/images/form-payment-flow.png)
    </Frame>
  </Step>
...
<AccordionGroup>
  ...
  <Accordion title="Credits aren't working">
    ...
    **Check:**
    ...
    [Learn more about credits →](/payments/credits/credit-system-overview)
  </Accordion>
...
1. [Understand credits](/payments/credits/credit-system-overview) - Learn the credit system
