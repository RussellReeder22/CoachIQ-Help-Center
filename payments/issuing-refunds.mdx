...
<Steps>
  ...
  <Step title="Click Refund button">
    ...
    <Frame>
      ![Stripe transaction detail page with Refund button highlighted](/images/refund-stripe.png)
    </Frame>
    <Warning>
  ...
  <Step title="Choose refund amount">
    ...
    **Partial refund:** Enter specific dollar amount to refund
    ...
    <Frame>
      ![Stripe refund form showing amount and reason fields](/images/refund-details.png)
    </Frame>
  </Step>
