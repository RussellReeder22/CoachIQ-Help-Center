...
**Where to find this**: Settings → Stripe → Disconnect Stripe
...
This banner appears even after you cancel your CoachIQ subscription. The Stripe connection stays active until you manually disconnect it. To remove this integration, follow the steps below.
...
<Steps>
  ...
  <Step title="Go to Settings → Stripe">

    From your CoachIQ dashboard, click **Settings** in the bottom-left corner, then click **Stripe** as an Admin.

  </Step>

  <Step title="Click Disconnect">

    Scroll to **Disconnect Stripe** at the bottom of the integration page. Review the confirmation before proceeding. Coach-role staff must ask an Admin; CoachIQ-managed demo connections cannot be disconnected here.
...
<AccordionGroup>
  ...
  <Accordion title="I already cancelled CoachIQ — can I still disconnect?">
    ...
    Yes. Log into your CoachIQ admin at [admin.coachiq.io](https://admin.coachiq.io) and follow the same steps. Without an active membership, you may see a membership or billing screen instead of the admin platform. If you can't log in, contact [info@coachiq.io](mailto:info@coachiq.io) and the team will disconnect it for you.
  ...
  <Accordion title="Is the Stripe Connect banner a security concern?">
    ...
    No. While the connection is active, CoachIQ can only process payments that you've configured in your dashboard. The connection enables the payment operations configured for your business. The banner is just Stripe's way of showing that a platform integration exists.
