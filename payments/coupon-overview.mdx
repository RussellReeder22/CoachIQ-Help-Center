...
<Frame>
  ![CoachIQ coupons page showing discount codes list with status and redemptions](/images/coupons-page.png)
</Frame>
...
<Frame>
  ![CoachIQ coupons page with filter and search options](/images/coupons-page.png)
</Frame>
...
| Limited months | Discounts invoices within the selected number of calendar months; this is not a count of sessions or payments |
...
| Ends when | You deactivate the coupon or it hits its limit | The membership lapses or is cancelled |
...
6. Choose membership duration and optional eligibility, expiry, product, and redemption limits
7. Save coupon
