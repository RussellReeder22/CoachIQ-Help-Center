...
icon: "chart-line"
keywords: ["stripe dashboard", "payouts", "stripe reports", "stripe customers", "view payments", "stripe login"]
---
...
<Tabs>
  ...
  <Tab title="Payments">
    **Complete transaction history**
    ...
    <Frame>
      ![Stripe Transaction Example](/images/transcation-stripe-example.png)
    </Frame>
