...
<Tabs>
  ...
  <Tab title="Option 3: Create Promotional Product">
    ...
    **Benefits**:
    ...
    - Clean credit logs
    - Can turn the product's credits off later from each athlete's credit tab if needed (the product itself can't be deleted once its credits have been used)
...
<AccordionGroup>
  <Accordion title="Can I delete credit logs?">
    ...
    **What you CAN do**:
    ...
    - Delete the product from their account, if none of its credits have been used
