...
icon: "book-open"
keywords: ["credits", "session credits", "credit packages", "credit balance", "buy credits", "use credits", "how credits work", "punch card", "prepaid sessions"]
---
...
<CardGroup cols={3}>
  <Card title="Setting Up Product Credit Packages" icon="box" href="/payments/credits/credits-products">
    Step-by-step guide to creating credit products.
  </Card>
