...
description: "Control how and where athletes can use their credits with scheduler restrictions and usage limits"
sidebarTitle: "Usage Limits"
icon: "shield-alt"
keywords: ["credit limits", "usage restrictions", "restrict credits", "scheduler specific credits", "credit per day", "booking limits"]
---
...
<Steps>
  ...
  <Step title="Scroll to Credit Limits section">
    ...
    <Frame>
      ![Credit Limits configuration in product builder](/images/credit-limits-product.png)
    </Frame>
  </Step>
...
<Steps>
  ...
  <Step title="Find payment/pricing section">
    Scroll to the **Payment** block

    Choose **Paywalled**, then under **How they pay** pick:

    - **Price** (\$ amount)
    - **Credit** ← THIS IS WHERE YOU CONFIGURE
    - **Either** (athlete chooses price or credits)

    Optionally set a **Buy more credits** link so athletes who run out are sent to the right product.

    <Frame>
      ![Scheduler payment configuration](/images/credit-charge-ui.png)
    </Frame>
  </Step>
...
<Steps>
  ...
  <Step title="Find Redeemable Schedulers Log">
    ...
    <Frame>
      ![Usage limits tracking in athlete profile](/images/credit-log-ui.png)
    </Frame>
  </Step>
