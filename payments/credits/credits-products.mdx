...
icon: "ticket"
keywords: ["credits products", "add credits to product", "credit packages", "session credits", "credits in products"]
---
...
<Tabs>
  ...
  <Tab title="Product-Specific Credits">
    **Can be set up to function like Master Credits**

    - No scheduler specific limitations
    - Can be used to book any session
    - Difference from Master Credits is that these credits live under the product specific credit bank

    **Can be restricted to certain schedulers**
    ...
    **Configure certain scheduler restrictions:**
...
<Steps>
  ...
  <Step title="Payment screen shows credit option">
    ...
    <Frame>
      ![Credit and Payment Options](/images/credit-and-payment-options.png)
    </Frame>
  </Step>
...
**Optional feature:** Not required.  Products don't have to award credits at all
...
**Configure credits in products:** [Product Builder →](/payments/product-builder)
...
**Attach products to schedulers:** [Attach Products →](/payments/attach-products)
