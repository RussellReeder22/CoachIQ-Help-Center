...
<Tabs>
  <Tab title="Subscription payments">
    **Subscriptions page shows Past Due status**
    ...
    <Frame>
      ![CoachIQ subscription with Past Due status after failed payment](/images/past-due-sub.png)
    </Frame>
  </Tab>
...
<Steps>
  <Step title="Identify Past Due subscriptions">
    ...
    <Frame>
      ![CoachIQ subscriptions page filtered to show Past Due subscriptions](/images/past-due-sub.png)
    </Frame>
  </Step>
  ...
  <Step title="Send payment page update link">
    ...
    <Frame>
      ![Stripe invoice details showing retrying status for failed payment](/images/invoice-stripe.png)
    </Frame>
    <Frame>
      ![Stripe payment page link to send to client for updating payment method](/images/payment-page-link.png)
    </Frame>
  </Step>
