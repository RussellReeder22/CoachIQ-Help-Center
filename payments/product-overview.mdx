...
<Frame>
  ![CoachIQ dashboard sidebar with Payments section expanded](/images/payments-sidebar.png)
</Frame>
...
<CardGroup cols={2}>
  <Card title="Athlete Portal Products Page" icon="store">
    ...
    Add products to sections in **App Builder → Products**. Athletes see them in your published portal. Native visibility depends on the app version and enabled purchase experience; see [Products page](/athlete-portal/products).
...
<Steps>
  ...
  <Step title="Find the product">
    ...
    <Frame>
      ![Product action menu showing Archive Product option](/images/product-archive-menu.png)
    </Frame>
  </Step>
...
<Frame>
  ![Products page filter dropdown showing Active, Archived, and All options](/images/product-archive-filter-dropdown.png)
</Frame>
...
**Processing fees**: You choose whether to absorb the combined Stripe + CoachIQ fee (2.9% + \$0.30, plus CoachIQ's 1% + \$0.20) or pass it to clients.
