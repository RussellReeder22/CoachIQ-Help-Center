...
icon: "clipboard-list"
keywords: ["forms", "intake form", "registration", "waiver", "collect information", "sign up form", "questionnaire", "data collection"]
---
...
<CardGroup cols={2}>
  <Card title="People" icon="users" href="/people/overview">
    When you require login/signup, form responses automatically appear on the athlete's profile and their data syncs to your People list. Returning visitors are asked to [sign in mid-form](/tools/forms/returning-visitor-sign-in).
  </Card>
...
- **No branching inside the form** — a form cannot change its own questions based on an answer. Automations can, though: the **Form Submitted** trigger exposes each question as an **Answer field**, so "if they selected Instagram, add the Instagram Lead tag" is built in [Automations](/tools/forms/responses-and-automations#automations-triggered-by-forms)
...
<CardGroup cols={2}>
  <Card title="Create Your First Form" icon="rocket" href="/tools/forms/creating-forms">
