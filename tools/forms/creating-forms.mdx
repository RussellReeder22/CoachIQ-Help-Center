...
Use the form's duplicate action to create a copy with its current questions, choices, and settings. The copy starts with **zero responses**; submissions stay with the original form. Review the copied questions and connections before sharing it for a new season or camp.
