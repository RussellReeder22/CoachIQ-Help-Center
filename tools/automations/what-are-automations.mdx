...
If your automations list has grown long, you can archive the ones you're no longer using instead of deleting them.

<Note>
Only inactive automations can be archived. Deactivate an automation first if it's still turned on.
</Note>

Archived automations move out of your main list into an **Archived** view, and can be restored at any time — a restored automation comes back as inactive, so you'll need to turn it back on if you want it running again.
