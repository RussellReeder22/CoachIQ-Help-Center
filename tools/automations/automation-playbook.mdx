...
<Note>
  Several of these use **Scheduled Automations**, which run on a schedule (daily, weekly, monthly) instead of reacting to an event. If you're new to those, check out [Scheduled Automations](/tools/automations/scheduled-automations) for a deeper explanation.
</Note>
