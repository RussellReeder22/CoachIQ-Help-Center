...
Click **Add Rule** to add a rule to the current group, and **Add And/Or** to nest a new group inside it. Nesting lets you express things like "(bought a membership **or** a credit pack) **and** has no future booking".
