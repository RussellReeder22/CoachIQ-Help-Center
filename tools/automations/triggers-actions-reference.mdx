...
icon: "list"
keywords: ["triggers", "actions", "conditions", "dynamic fields", "automation triggers", "automation actions", "trigger reference"]
---
...
<Note>
**New to automations?** Start with [Build Your First Automation](/tools/automations/build-your-first-automation) for a hands-on walkthrough.
</Note>
