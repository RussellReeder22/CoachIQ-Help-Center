...
<Note>
Each email uses 0.1 credit per address, including CC and BCC. If your balance can't cover it, the action fails with "Not enough credits to send this email", nothing is sent, and the automation log shows the failure. See [How credits work](/inbox/sms-credits).
</Note>
