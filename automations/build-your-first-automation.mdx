...
<Steps>
  ...
  <Step title="Add a Condition">
    ...
    <Frame>
      ![Adding the subscription condition](/images/automations/add-condition.png)
    </Frame>
    <Tip>
  ...
  <Step title="Add Your First Action — Send Email">
    ...
    <Frame>
      ![Configuring the send email action](/images/automations/send-email-action.png)
    </Frame>
  </Step>
  <Step title="Add a Second Action — Add Tag">
    ...
    <Frame>
      ![Adding a tag to the user](/images/automations/add-tag-action.png)
    </Frame>
  </Step>
  <Step title="Name and Activate">
    ...
    <Frame>
      ![Activating the automation](/images/automations/activate-automation.png)
    </Frame>
  </Step>
</Steps>
