...
<Steps>
  ...
  <Step title="Create your trial session product">
    ...
    **Product details:**
    ...
    <Frame>
      ![Trial Session Example](/images/trial-session-example.png)
    </Frame>
    **Description example:**
...
<Steps>
  ...
  <Step title="Customize brand colors and theme">
    **Design Settings:**
  ...
  <Step title="Enable active portal sections">
    **Navigation Menu Configuration:**

    Enable only the sections that match what you offer:
...
<Steps>
  <Step title="Navigate to Products Page configuration">
    In **App Builder**, select **Products** from the section list.
  </Step>
  <Step title="Create product sections">
    Click **\+ Add Section** to organize your offerings.

    **Recommended section structure:**

    **Section 1: Memberships or Packages**
  ...
  <Step title="Assign products to sections">
    For each section:
...
<Steps>
  <Step title="Navigate to Schedule Page configuration">
    In **App Builder**, select **Schedule** from the section list.
  </Step>
  <Step title="Create schedule sections">
    Click **\+ Add Section** to organize your bookable sessions.

    **Option A: Organize by Session Type** (recommended for most coaches)

    **Section 1: 1-on-1 Training**
    ...
    **Option B: Organize by Location** (recommended for multi-location facilities)

    Example:

    **Section 1: Downtown Facility**
  ...
  <Step title="Assign sessions to sections">
    For each section:
  ...
  <Step title="Preview your athlete portal">
    Click **Preview** to see the portal as athletes will experience it.
...
<Steps>
  <Step title="Navigate to Website Builder">
    From your dashboard, select **Website** → **Edit** → **\+ New Page**.
  </Step>
