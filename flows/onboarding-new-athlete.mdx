...
<Steps>
  ...
  <Step title="Create your trial session product">
    ...
    **Description example:**
    ...
    <Tip>
      **Pro tip**: Offering something free removes the barrier to entry. Even a small discount (like \$15) can work if you want to qualify serious prospects.
    </Tip>
    Click **Save Product**.
  </Step>
  <Step title="Create your membership product">
    ...
    **Product details:**
    ...
    - **Type**: Select **Membership** (recurring)
    - **Billing**: Monthly recurring
    - **Price**: Your monthly rate (e.g., \$199/month)
    - **Access**: Define what's included (unlimited sessions, 3x/week, etc.)
    ...
    **Description example:**
    ...
    <Check>
      **Success!** You now have a clear pathway: Free trial → Paid membership
    </Check>
  </Step>
...
<Steps>
  <Step title="Navigate to Schedule and set your availability">
    ...
    See **Availability** in the schedule section, then click **\+ Add Availability**.
  ...
  <Step title="Create your trial session scheduler">
    ...
    From the Schedule page, visit **Schedulers** → **\+ New Scheduler**.

    **Basic settings:**

    - **Name**: "Trial Session Booking"
    - **Duration**: 60 minutes (recommended for proper assessment)
    - **Session type**: One-on-one, Semi-Private, Small Group (your choice)
    - **Buffer time**: 15 minutes between sessions (for notes and setup)
    ...
    **Booking rules:**
    ...
    - **Max bookings per slot**: 1 (for one-on-one)
    - **Max per client**: 1 trial session total (prevents repeat free sessions)
  ...
  <Step title="Create your member training scheduler">
    ...
    **Basic settings:**
    ...
    - **Name**: "Member Training Sessions"
    - **Duration**: Your standard session length (typically 45-60 minutes)
    - **Access**: Members only (require active membership)

    **Attach your membership product:**

    - **Linked product**: Select your membership product
    - This ensures only active members can book

    **Availability settings:**

    - **Use availability**: Select all your training availability blocks
    - **All time slots**: Members get access to your full schedule
    - **Recurring bookings**: Enable this feature (lets members book weekly standing appointments)

    **Booking rules:**

    - **Advance booking**: Up to 2-4 weeks ahead
    - **Cancellation policy**: Require 24 hours notice
    - **Late cancel fee**: Optional (e.g., charges session credit or fee)
    - **Reschedule**: Allow members to reschedule themselves within policy
...
<Steps>
  ...
  <Step title="Create your lead capture form">
    ...
    **Required fields (keep it minimal):**
    ...
    - Email Address
    - Phone Number
    - "What are your training goals?" (short text)

    <Tip>
      **Pro tip**: Every field you add reduces conversion. Keep lead forms to 3-4 fields max. You'll collect detailed info later.
    </Tip>
  ...
  <Step title="Create your athlete intake form">
    This comprehensive form collects everything you need before their first session.

    **Form settings:**

    - **Name**: "New Athlete Intake & Assessment"
    - **Send to**: New trial bookings (automatically via automation)
    - **Due date**: 24 hours before scheduled session
    ...
    **Health & Fitness Background:**
    ...
    - Current medications
    - Doctor clearance (if over 40 or health concerns)
    ...
    **Logistics:**
    ...
    <Note>
      **Legal consideration**: Include a liability waiver section or link to your full waiver document. Consult a lawyer for your jurisdiction's requirements.
    </Note>
    Click **Save Form**.

    <Check>
      **Success!** You now have both a low-friction lead capture form and a comprehensive intake process.
    </Check>
  </Step>
</Steps>
...
- Athlete intake form (detailed assessment)

<Tip>
  **Time-saving tip**: Clone these products and schedulers to create variations quickly. Select any product/scheduler and click **Duplicate** to use as a template.
</Tip>
...
<Steps>
  <Step title="Navigate to Athlete Portal settings">
    From your dashboard, select **Settings** → **Athlete Portal**.
  </Step>
