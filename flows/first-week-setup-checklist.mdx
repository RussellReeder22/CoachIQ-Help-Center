...
<AccordionGroup>
  <Accordion title="What's the difference between availability and schedulers?">
    ...
    **Schedulers** = Specific booking portals that use your availability plus additional rules for different services
    ...
    Think of availability as your hours available and schedulers as filtered views of that schedule for different purposes.
  </Accordion>
  <Accordion title="How do I block out vacation time?">
    Go to **Schedule → Availability → Specific Dates** to create a new unavailability.
  </Accordion>
</AccordionGroup>
...
<Steps>
  ...
  <Step title="Configure portal modules">
    ...
    <Tabs>
      <Tab title="Schedule">
        1. Navigate to the **Schedule** page in App Builder
  ...
  <Step title="Set up your domain">
    ...
    <Tabs>
      <Tab title="Register a New Domain">
        We'll work with you to register a new domain. Simply email us with your request for a domain name and we'll check for availability and handle everything from there.
      </Tab>
      <Tab title="Connect Existing Domain">
...
<CardGroup cols={2}>
  <Card title="Add Your First Client" icon="user-plus" href="/people/adding-editing-clients">
