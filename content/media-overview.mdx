...
<Frame>
  ![Program Access Options](/images/program-access-options.png)
</Frame>
...
<CardGroup cols={2}>
  <Card title="Uploading & Organizing Media" icon="cloud-arrow-up" href="/content/media-hub">
    Start by getting your videos and images into CoachIQ's Media Hub.
  </Card>
  <Card title="Creating Interactive Lessons" icon="presentation-screen" href="/content/lessons-overview">
  ...
  <Card title="Sharing & Selling Programs" icon="share-nodes" href="/content/sharing-pricing-programs">
