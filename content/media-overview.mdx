...
Media Hub is your central storage for all videos and images in CoachIQ. Upload your training content here, organize it with tags, then pull it into lessons and programs.
...
- **In the Lesson Builder** — Add media as slides in your interactive lessons
- **In the Program Builder** — Add standalone videos or images directly to program chapters
