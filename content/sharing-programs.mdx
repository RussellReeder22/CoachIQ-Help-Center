...
description: "Learn how to price your programs, set up paywalls, share privately with specific athletes, and connect payment products in CoachIQ."
sidebarTitle: "Sharing & Pricing"
icon: "share-nodes"
---

Once you've built a program, you need to decide how athletes will access it. CoachIQ gives you flexible options: share for free, sell for a price, assign privately to specific people, or any combination. This guide covers all your sharing and monetization options.
...
<AccordionGroup>
  <Accordion title="Selling an online course to the public">
    ...
    **Result**: Athletes see the program, purchase the product, and get immediate access.
  </Accordion>
  ...
  <Accordion title="Giving free content to current training clients">
    ...
    **Result**: Only assigned clients see the program. It's completely free for them.
  </Accordion>
  ...
  <Accordion title="VIP-only paid program">
    ...
    **Result**: Only assigned VIPs see the program. They still must purchase to access content.
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  ...
  <Accordion title="Do I need to assign athletes if the program is public?">
    No. Public programs are visible to all athletes. You only need to assign athletes when Private mode is enabled.
  </Accordion>
