...
icon: "share-nodes"
keywords: ["share program", "sell program", "publish program", "paywall", "program pricing", "monetize content", "program access"]
---
...
The [Athlete Portal](/athlete-portal/understanding-your-athlete-portal) is your branded app where athletes access your content. For athletes to see any program, you must add it to the portal's Programs section.
...
Once a program is added to your Athlete Portal, you control _who_ can access it through Share settings in the Program Builder.
...
<Frame>
  ![Progam Share Settings](/images/progam-share-settings.png)
</Frame>
...
1. You create **[Products](/payments/product-overview)** in CoachIQ (one-time purchases or subscriptions)
2. You [link those products](/payments/attach-products) to your program
3. When an athlete purchases any linked product, they automatically get access to the program

<Note>
  **Products come first**: You must [create at least one Product](/payments/product-builder) in CoachIQ before you can paywall a program. Products are created in the Payments section of your dashboard.
</Note>
...
<Steps>
  ...
  <Step title="Select products">
    ...
    _Example: Select "Bronze Package - 10"_
  </Step>
  <Step title="Save">
...
<AccordionGroup>
  <Accordion title="I configured Share settings but athletes can't see my program. What's wrong?">
    You need to add the program to your **Athlete Portal**. Go to Website & App → Athlete Portal → Edit → Content, and add the program there. Share settings control _who_ can access a program, but the Athlete Portal controls _whether_ it appears in the app at all.
  </Accordion>
...
<CardGroup cols={3}>
  <Card title="Set Up Your Athlete Portal" icon="mobile-screen" href="/athlete-portal/understanding-your-athlete-portal">
    Configure your branded app where athletes access programs, schedules, and communication.
  </Card>
  <Card title="Create Products" icon="credit-card" href="/payments/product-overview">
...
<CardGroup cols={2}>
  <Card title="Product Builder" icon="credit-card" href="/payments/product-builder">
    Step-by-step guide to creating the products you link to paywalled programs.
  </Card>
  <Card title="Attach Products to Content" icon="credit-card" href="/payments/attach-products">
    Learn the details of connecting payment products to your programs.
  </Card>
  <Card title="Scheduling Overview" icon="calendar" href="/scheduling/overview">
    Pair your programs with scheduling so athletes can book training sessions.
  </Card>
  <Card title="Forms Overview" icon="file-lines" href="/forms/overview">
    Collect athlete information with standalone forms outside of programs.
  </Card>
</CardGroup>