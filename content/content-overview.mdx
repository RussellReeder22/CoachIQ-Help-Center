...
<Steps>
  <Step title="Upload your media">
    ...
    *Example: Upload 10 shooting drill videos and tag them "Shooting Drills"*
  </Step>
  ...
  <Step title="Create lessons (optional but powerful)">
    ...
    *Example: Create a "Shooting Form Basics" lesson with 5 slides—video demo, key points, quiz, and upload prompt*
  </Step>
  ...
  <Step title="Build your program">
    ...
    *Example: Create "30-Day Shooting Program" with 10 lessons and 5 bonus drill videos*
  </Step>
  ...
  <Step title="Share with athletes">
    ...
    *Example: Sell access for $49, or assign it free to your current training clients*
  </Step>
</Steps>
