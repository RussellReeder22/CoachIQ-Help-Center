...
icon: "layer-group"
keywords: ["lesson elements", "media element", "text element", "quiz", "button", "upload", "form element", "lesson building blocks"]
---
...
The Media element pulls videos and images from your [Media Hub](/content/media-overview) to display on slides. This is typically the foundation of most slides—start with media, then layer other elements on top.

<Frame>
  ![Media Hub In Lesson](/images/media-hub-in-lesson.png)
</Frame>
...
<Frame>
  ![Lesson Example](/images/lesson-example.png)
</Frame>
...
<Frame>
  ![Upload Lesson Feature](/images/upload-lesson-feature.png)
</Frame>
...
All interactive elements (Quiz, Form, Upload) collect responses at the **[Program](/content/programs-overview) level**, not the individual lesson level.
...
<CardGroup cols={2}>
  <Card title="Create Your First Lesson" icon="presentation-screen" href="/content/lesson-overview">
...
<CardGroup cols={2}>
  <Card title="Uploading & Organizing Media" icon="video" href="/content/media-overview">
    Get videos and images into Media Hub so you can use them in lesson elements.
  </Card>
  <Card title="Sharing & Selling Programs" icon="credit-card" href="/content/sharing-programs">
    Configure pricing and access for programs that contain your lessons.
  </Card>
  <Card title="Content in the Athlete Portal" icon="mobile" href="/athlete-portal/content">
    Control how athletes discover and access your lesson content.
  </Card>
  <Card title="Forms Overview" icon="file-lines" href="/forms/overview">
    Build standalone forms for collecting information outside of lessons.
  </Card>
</CardGroup>