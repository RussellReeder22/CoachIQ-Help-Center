...
keywords: ["programs", "training programs", "online courses", "digital products", "program builder", "create program", "course structure"]
---

Programs are the top-level container for everything you deliver to athletes. They're how you package your lessons, videos, and training content into structured courses that athletes access through the CoachIQ app. Think of programs as the "product" athletes actually see and work through in the [Athlete Portal](/athlete-portal/understanding-your-athlete-portal).
...
- **Programs can be sold** as paid [products](/payments/product-overview) or shared free
...
<AccordionGroup>
  ...
  <Accordion title="Is there a limit to how many chapters a program can have?">
    Programs used to stop at 50 checkpoints (chapters). That cap was raised in August 2026, so long programs no longer have to be split just to keep adding content. There is still an upper limit; if you reach it, contact support. Very long programs often read better split into "levels" anyway, so athletes see progress sooner.
  </Accordion>
...
<CardGroup cols={2}>
  <Card title="Share & Sell Your Programs" icon="share-nodes" href="/content/sharing-programs">
    Learn how to configure pricing, share programs privately, and connect to payment products.
  </Card>
  <Card title="Create Interactive Lessons" icon="presentation-screen" href="/content/lesson-overview">
