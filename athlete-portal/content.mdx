...
icon: "graduation-cap"
keywords: ["programs in portal", "athlete portal content", "training programs", "certifications", "content sections", "program display"]
---
...
![CoachIQ programs library showing all available programs in grid view](/images/coachiq-programs-grid-view-all.png)
...
![Athlete view of the Programs page with training content and progress](/images/athletesideprograms.png)
...
<Steps>
  <Step title="Navigate to App Builder">
    ...
    ![CoachIQ App Builder sidebar with App selected in left navigation](/images/athelteportal.png)
  </Step>
  <Step title="Select Content tab">
    Click on the **Content** tab in the main navigation.

    ![CoachIQ App Builder Content tab showing page sections](/images/coachiq-app-builder-content-page-sections.png)
  </Step>
  <Step title="Choose Programs">
    Select **Programs** from the content options to access your program configuration page.

    ![CoachIQ App Builder program selection modal for adding content](/images/coachiq-app-builder-add-content-program.png)
  </Step>
</Steps>
...
<Steps>
  <Step title="Locate the Active toggle">
    ...
    ![CoachIQ App Builder page actions menu with Active toggle](/images/coachiq-app-builder-page-actions-menu.png)
  </Step>
...
![CoachIQ App Builder Add Section button for organizing programs](/images/coachiq-app-builder-add-section-button.png)
...
<Steps>
  <Step title="Locate Welcome Section">
    ...
    ![CoachIQ App Builder Welcome Section dropdown selector](/images/coachiq-app-builder-welcome-section-dropdown.png)
  </Step>
...
<Steps>
  <Step title="Open program settings">
    ...
    ![CoachIQ Program Builder Share button for access settings](/images/coachiq-program-builder-share-button.png)
  </Step>
  ...
  <Step title="Configure private access">
    ...
    ![CoachIQ program paywall and private access toggle settings](/images/coachiq-program-paywall-private-settings.png)
...
Use the Settings panel to rename the Programs tab and update the page URL.

<Steps>
  <Step title="Open the Settings panel">
    Click the **gear icon** in the top right of the Programs page to open the Settings panel.

    ![CoachIQ App Builder page settings modal with URL slug and SEO options](/images/coachiq-app-builder-seo-settings-modal.png)
  </Step>
  <Step title="Rename the page">
    The first field at the top of the Settings panel is the **Page Name** — the display name athletes see as the tab in their portal. Update it to match your branding (e.g., "Training", "Content", "Resources").
  </Step>
  <Step title="Update the URL slug">
    The **Slug** field controls the URL path for this page (e.g., `/programs`, `/training`).
  </Step>
  <Step title="Configure description">
    Add a **Description** for SEO context.
  </Step>
...
<Steps>
  <Step title="Click Preview Page">
    ...
    ![CoachIQ App Builder page actions menu with Preview Page option](/images/coachiq-app-builder-page-actions-menu.png)
  </Step>
...
- [Client Profiles](/people/client-profiles/client-profiles)
