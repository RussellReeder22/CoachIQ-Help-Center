...
icon: "credit-card"
keywords: ["products in portal", "athlete portal payments", "native checkout", "sell products", "membership sales", "product display"]
---
...
![CoachIQ Athlete Portal Products page displaying memberships and packages](/images/athlete-portal-product-page.png)

<Warning>

  **App availability varies**: Products and checkout depend on your released native app version and enabled features. Configure product visibility intentionally. The web portal remains available for purchases when an app does not offer the required checkout.
...
![CoachIQ web portal product cards with pricing and purchase buttons](/images/CleanShot2025-09-26at19.44.47.png)
...
<Tabs>
  <Tab title="⚠️ Mobile Apps">
    ...
    **iOS and Android apps**
    ...
    Supported app versions can display configured products and offer eligible native checkout. Other app versions or purchases use browser checkout. Check your actual released app; a new native payment capability does not automatically make every product visible.

    See [Native app booking](/athlete-portal/native-app-booking).
...
- **Platform availability**: Web plus supported native app versions and configuration
...
![CoachIQ Products page listing available products in the admin dashboard](/images/Products-page.png)
...
<Steps>
  <Step title="Locate the Active toggle">
    ...
    ![CoachIQ Athlete Portal action bar with Update Page and Settings buttons](/images/Athlete-portal-update-page-update-settings-preivew-page.png)
  ...
  <Step title="Toggle visibility">
    ...
    <Info>
      ...
      Check both the page configuration and the installed app version when verifying mobile visibility.
...
<Steps>
  <Step title="Click Add Products">
    ...
    <Frame>
      ![Add Products button in section](/images/athlete-portal-add-product-add-section.png)
    </Frame>
  </Step>
...
<Steps>
  <Step title="Click Add Section">
    ...
    <Frame>
      ![Add Section button for products](/images/athlete-portal-add-product-add-section.png)
    </Frame>
  </Step>
...
<Steps>
  <Step title="Open the Settings panel">
    ...
    <Frame>
      ![Settings menu for Products page](/images/athleteportal-productpage-SEOsettings-customslug.png)
    </Frame>
  </Step>
...
Share direct web purchase links when athletes cannot access the required checkout in their installed app.
...
<Steps>
  ...
  <Step title="Confirm mobile app behavior">
    ...
    Check the released iOS/Android apps to verify the intended product visibility and checkout.
...
<Steps>
  ...
  <Step title="Click Update Page">
    ...
    <Check>
      ...
      Changes apply to your published portal. Native visibility also depends on the installed app version and enabled purchase experience.
...
<AccordionGroup>
  <Accordion title="Why can't my athletes see products on the mobile app?">
    ...
    Check that the Products page is enabled and published, then check the athlete’s installed app version and supported payment experience. Native payments do not automatically turn on your Products page. If checkout is unavailable in that app, share the product’s web purchase link.
  ...
  <Accordion title="Can I accept payments through the app at all?">
    ...
    Native payment availability depends on the released app and eligible purchase. When it is unavailable, you can:
  ...
  <Accordion title="How do I explain this to frustrated athletes?">
    ...
    Sample message:
    "If you do not see the purchase option in your app, use our web portal to buy your membership or package. Then return to the app to use it."
...
1. Check the athlete’s app version and whether it supports the intended purchase; offer the web purchase link when needed.
