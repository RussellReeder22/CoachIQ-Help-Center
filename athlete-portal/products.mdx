...
<Info>
  **Where to find this**: Dashboard → App Builder → Content → Products
</Info>
...
<Tabs>
  <Tab title="⚠️ Mobile Apps">
    ...
    **Alternative**: Direct athletes to your web portal for purchases
  </Tab>
...
<Steps>
  ...
  <Step title="Choose Products">
    ...
    <Frame>
      ![Products page navigation in App Builder](/images/products-page-navigation.png)
    </Frame>
  </Step>
</Steps>
...
<Steps>
  <Step title="Locate the Active toggle">
    ...
    <Frame>
      ![Active toggle for Products page](/images/products-active-toggle.png)
    </Frame>
  </Step>
...
<Steps>
  <Step title="Click Add Products">
    ...
    <Frame>
      ![Add Products button in section](/images/add-products-button.png)
    </Frame>
  </Step>
...
<Steps>
  <Step title="Click Add Section">
    ...
    <Frame>
      ![Add Section button for products](/images/add-section-products.png)
    </Frame>
  </Step>
...
<Steps>
  <Step title="Access settings">
    ...
    <Frame>
      ![Settings menu for Products page](/images/products-settings-menu.png)
    </Frame>
  </Step>
