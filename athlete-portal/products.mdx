...
icon: "credit-card"
keywords: ["products in portal", "athlete portal payments", "iOS restrictions", "sell products", "membership sales", "product display"]
---
...
<Info>
**Products are hidden by default**: Creating a product in Payments → Products doesn't automatically make it visible to athletes. You must explicitly add products to this page (or attach them to schedulers/forms) for athletes to discover them. This lets you set up products before you're ready to launch. [Learn more about product visibility →](/payments/product-overview#product-visibility-where-athletes-can-find-products)
</Info>
