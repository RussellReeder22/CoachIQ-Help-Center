...
<AccordionGroup>
  ...
  <Accordion title="How do athletes book and pay in the mobile app?">
    Booking happens in the app. If a scheduler accepts both payment and credits, the app asks the athlete whether to pay or use a credit, the same choice as on the web. Anything that needs a card (a product, a membership, a paid booking without credits) opens in the browser to finish checkout, then the athlete returns to the app. See [Booking in the native app](/athlete-portal/native-app-booking).
  </Accordion>
