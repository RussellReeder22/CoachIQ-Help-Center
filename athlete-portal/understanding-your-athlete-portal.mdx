...
icon: "mobile"
keywords: ["athlete portal", "coaching app", "athlete app", "mobile app", "web portal", "app access", "portal overview"]
---
...
![CoachIQ Athlete Portal overview in the App Builder dashboard](/images/athelteportal.png)
...
![CoachIQ Athlete Portal as seen by athletes on mobile and web](/images/rawathleteportalathlete.png)
...
Your portal is available on the web and in supported iOS and Android apps. [Personalized Apps](/power-ups/personalized-app) are now available for both stores; each business's listing and update is released separately.

A personalized app can prompt a new athlete to register on their first login attempt. Purchases depend on the installed app version and enabled checkout: eligible native purchases can stay in the app, while other purchases open the browser. The website remains a useful starting point for account creation and purchasing.
...
![Athlete view of session scheduling with available time slots](/images/athletesidesessions.png)
...
![Athlete view of training programs with progress tracking](/images/athletesideprograms.png)
...
![Athlete view of Channels with announcements and direct messages](/images/athletesidechannels.png)
...
Athletes can view their credit balance, renewal dates, and which schedulers their credits work for by tapping their profile icon.

<Frame>
  ![Athlete mobile view showing credit balances and redeemable schedulers](/images/athlete-portal-credit-balance-mobile.png)
</Frame>

✅ **Purchases** (web, or supported native checkout)
...
![CoachIQ App Builder coach control panel for managing the Athlete Portal](/images/athleteportalcoachesside.png)
...
<AccordionGroup>
  ...
  <Accordion title="Reader App">
    ...
    A term for apps that display content purchased elsewhere. Do not use it as a blanket description of current CoachIQ checkout; check the installed app and enabled features.
...
<AccordionGroup>
  ...
  <Accordion title="How do athletes create an account?">

    Athletes can create an account on your website. Personalized apps also prompt new athletes to register on their first login attempt, using your configured sign-up fields.
  ...
  <Accordion title="Can parents and athletes share an account?">
    It's best practice to have separate accounts for tracking and communication, but parents can create accounts to manage younger athletes' bookings. Parents can now add and switch between family members themselves from **Settings → Family** in the portal — see [Family Accounts](/athlete-portal/family-accounts).
  </Accordion>
  <Accordion title="Where do iOS users make purchases?">

    Use the checkout offered by the released app. Eligible purchases can use native checkout where enabled; otherwise complete the purchase on the web.

  </Accordion>
  <Accordion title="Should I direct people to web or app first?">
    Always direct new users to your website first to create accounts and handle initial payments. After that, they can use the mobile app for daily access. The exception is a branded [Personalized App](/power-ups/personalized-app), which prompts an athlete with no account to sign up on their first login attempt.
  </Accordion>
  <Accordion title="How do athletes book and pay in the mobile app?">

    Booking happens in the app. If a scheduler accepts both payment and credits, the app asks the athlete whether to pay or use a credit, the same choice as on the web. Card checkout can stay in the app where enabled for the purchase, or open the browser on other versions. See [Booking in the native app](/athlete-portal/native-app-booking).

  </Accordion>
  <Accordion title="Do athletes get logged out when CoachIQ pushes an update?">
    No. If a platform update lands while an athlete or coach is using the app, the app signs them back in once the update completes instead of dropping them at the login screen. An athlete who still ends up logged out should update the app from the App Store or Google Play and sign in once.
  </Accordion>
  <Accordion title="What happens when an athlete requests account deletion?">
    Athletes can request deletion of their account from inside the CoachIQ app or your Personalized App (Apple requires this of every app with sign-up). The request arrives in your **Inbox** as a message from that athlete; nothing is deleted automatically. Action it the way you would any other request: confirm with the athlete, then remove them from your organization from their profile. See [Block or remove an athlete](/people/block-and-remove-athletes).
  </Accordion>
</AccordionGroup>
...
<Tip>
  ...
  **Set clear expectations**: Share the correct App Store or Google Play link for your business and explain the checkout available in that app.
...
- [App Builder Setup & Navigation](/athlete-portal/app-builder-navigation-and-interface) - Learn the interface and how to make changes
...
<CardGroup cols={2}>
  <Card title="Products in Your Portal" icon="credit-card" href="/athlete-portal/products">
    Display and sell memberships, packages, and products
  </Card>
  <Card title="Page Paywalls" icon="lock" href="/athlete-portal/paywall-settings">
  ...
  <Card title="Booking in the native app" icon="mobile-screen" href="/athlete-portal/native-app-booking">
    What athletes and parents see when they book from the iOS or Android app
  </Card>
  <Card title="Family Accounts" icon="people-roof" href="/athlete-portal/family-accounts">
    Parents, managed children, and who gets the reminders
  </Card>
  <Card title="Scheduling Overview" icon="calendar" href="/scheduling/overview">
    Set up session types, availability, and booking rules
  </Card>
  <Card title="Product Overview" icon="box" href="/payments/product-overview">
    Understand how products, pricing, and visibility work
  </Card>
  <Card title="Inbox Overview" icon="inbox" href="/inbox/inbox-overview">
    Communicate with athletes through messages and announcements
  </Card>
  <Card title="Content Overview" icon="video" href="/content/content-overview">
    Manage programs, lessons, and media for your athletes
  </Card>
