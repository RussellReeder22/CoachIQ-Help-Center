...
icon: "palette"
keywords: ["design settings", "theme", "dark mode", "light mode", "brand colors", "portal customization", "app appearance"]
---
...
![CoachIQ Athlete Portal design settings with theme and color options](/images/athlete-portal-design-settings.png)
...
![CoachIQ Athlete Portal color picker for selecting brand colors](/images/Athlete-portal-design-settings-selectcolor.png)
