...
icon: "users"
keywords: ["family account", "multiple athletes", "parent booking", "book for kids", "siblings", "shared credits", "family booking"]
---
...
Parents can now add and switch between family members themselves from **Settings → Family** in the athlete portal, without you setting up each child's access by hand — see [Family Accounts](/athlete-portal/family-accounts). Credits and billing still work exactly as described below.
