...
The **Coaches** tab is the scheduling view of your staff. It lists every coach who is connected to at least one scheduler, shows their availability, and tells you which schedulers each one covers (**USED BY n SCHEDULERS**).
