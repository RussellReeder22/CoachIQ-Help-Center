...
<AccordionGroup>
  ...
  <Accordion title="No available slots showing when I test">
    ...
    **How to fix**:
    ...
    For detailed troubleshooting, see [Why Aren't My Sessions Showing Up?](/help-center/helping-your-athlete/sessions-not-showing)
  </Accordion>
...
<CardGroup cols={3}>
  ...
  <Card title="Creating Availability" icon="calendar-check" href="/scheduling/creating-your-availability">
  ...
  <Card title="Troubleshooting" icon="tools" href="/help-center/helping-your-athlete/sessions-not-showing">
