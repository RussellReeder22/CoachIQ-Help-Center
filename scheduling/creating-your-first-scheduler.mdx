...
<Steps>
  <Step title="Enter scheduler name">
    ...
    **Avoid in name**:
    ...
    <Frame>
      ![Scheduler Name Pn](/images/scheduler-name.png)
    </Frame>
    <Tip>
...
<Steps>
  <Step title="Locate the Availability section">
    ...
    <Frame>
      ![Set Scheduler Availablity Pn](/images/set-scheduler-availablity.png)
    </Frame>
  </Step>
  ...
  <Step title="Add an Additional Availablity (optional)">
    ...
    **Good to use if you're:**
    ...
    <Frame>
      ![Additional Availability Pn](/images/additional-availability.png)
    </Frame>
  </Step>
</Steps>
...
<Steps>
  <Step title="Enable reminders">
    ...
    <Frame>
      ![Reminders UI Pn](/images/Reminders-UI.png)
    </Frame>
  </Step>
...
<Steps>
  <Step title="Locate location section">
    ...
    <Frame>
      ![Location Scheduler Ui Pn](/images/location-scheduler-ui.png)
    </Frame>
  </Step>
...
<Steps>
  <Step title="Find connected coaches section">
    ...
    <Frame>
      ![Connected Coaches Ui Pn](/images/connected-coaches-ui.png)
    </Frame>
  </Step>
...
<Steps>
  <Step title="Get your booking link">
    ...
    <Frame>
      ![Scheduler Link Pn](/images/scheduler-link.png)
    </Frame>
  </Step>
