...
icon: "check-circle"
keywords: ["quick start", "setup checklist", "get started", "scheduling setup", "launch checklist"]
---
...
<CardGroup cols={3}>
  ...
  <Card title="Credit System" icon="coins" href="/payments/credits/credit-system-overview">
