...
<Frame>
  ![Scheduling › Setup › Defaults: Timing, Scheduling window, Booking rules, Limits](/images/scheduling/setup-defaults.png)
</Frame>
...
<CardGroup cols={2}>
  ...
  <Card title="Credit-based scheduling" icon="coins" href="/scheduling/setting-up-payment-options#option-3-setting-up-credit-based-sessions">
