...
<Note>
  Defaults apply to schedulers you create **after** you change them. Existing schedulers keep their own values. Screenshots for this tab are being captured; labels were checked against the live app on 2026-09-02.
</Note>
