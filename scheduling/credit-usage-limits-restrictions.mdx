...
<Info>
  **Where to find this**: Dashboard → Payments → Products → [Product] → Credit Limits section
</Info>
...
<Note>
  **Prerequisites**:
  ...
  - Understanding credit types ([Article #23](/scheduling/credit-system-explained))
  - Familiarity with managing credits ([Article #25](/scheduling/managing-athlete-credits))
</Note>
...
<Tabs>
  ...
  <Tab title="Athlete Fairness">
    **Limits create fairness:**
    ...
    ✅ Stops credit hoarding behavior\
    ✅ Encourages consistent training vs binge booking\
