...
<Steps>
  ...
  <Step title="Choose your group and guest options">
    ...
    <Frame>
      ![Sync to Google Calendar settings showing the combine group bookings and add clients as event guests toggles](/images/scheduler-google-calendar-toggles.png)
    </Frame>
  </Step>
