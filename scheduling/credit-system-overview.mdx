...
<AccordionGroup>
  ...
  <Accordion title="Unlimited Monthly Subscription">
    ...
    **Example**: "\$400/month Unlimited - 12 Credits/month (up to 3x/week)"
    ...
    See [Subscription Scheduling](/scheduling/recurring-credit-memberships) for full details.
  </Accordion>
</AccordionGroup>
...
See [Subscription Scheduling](/scheduling/recurring-credit-memberships) for full comparison.
...
<CardGroup cols={3}>
  <Card title="Setting Up Product Credit Packages" icon="box" href="/payments/credits-products">
  ...
  <Card title="Credit Usage Limits" icon="lock" href="/scheduling/credit-usage-limits-restrictions">
