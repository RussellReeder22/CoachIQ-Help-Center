...
Credit-based scheduling is a **two-step setup** that links together: create credit-issuing products on the Payment side (**Payments → Products**), then configure schedulers to accept those credits on the Schedule side (**Schedule → Schedulers**). Both halves are covered below.
