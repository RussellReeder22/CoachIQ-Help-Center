...
<Steps>
  ...
  <Step title="Select direct payment option">
    ...
    <Frame>
      ![Direct payment option selected](/images/paywall-ui.png)
    </Frame>
  </Step>
...
<Steps>
  ...
  <Step title="Test insufficient credits">
    ...
    - **(Optional) Verify** a link to purchase more credits appears (if the credit renew link is enabled)
...
<AccordionGroup>
  ...
  <Accordion title="Athlete has credits but can't use them to book">
    ...
    **How to fix:**
    ...
    1. Verify scheduler has credit payment enabled: Scheduler Settings → Payment → Credit Charge
