...
<Note>
  Screenshots for the Setup tabs are being captured. Labels below match the app as of September 2026.
</Note>
...
<Steps>
  ...
  <Step title="Set hours">
    Each location carries its own hours. These are informational for your team and show alongside the location's schedulers; the actual bookable windows come from your [availability templates](/scheduling/how-availability-works).
  </Step>
  <Step title="Save">
