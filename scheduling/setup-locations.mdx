---
title: "Locations"
description: "Save the places you coach, including Google Meet and Zoom links, attach them to schedulers, give individual dates their own venue, and let athletes see exactly where to show up."
sidebarTitle: "Locations"
icon: "map-pin"
keywords: ["locations", "address", "facility", "where sessions happen", "multiple locations", "scheduler location", "setup locations", "per-date venue", "different location each date", "venue per date", "virtual location", "Google Meet", "Zoom", "online sessions", "video call sessions"]
---
