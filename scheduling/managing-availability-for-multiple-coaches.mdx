...
<Steps>
  ...
  <Step title="Assign multiple coaches to the scheduler">
    ...
    <Frame>
      ![CoachIQ scheduler with multiple connected coaches assigned](/multi-connected-coaches.png)
    </Frame>
  </Step>
...
<Steps>
  <Step title="Filter by individual coach">
    ...
    **How**:
    ...
    <Frame>
      ![CoachIQ calendar filtered to show a single coach's schedule](/coach-schedule-cal.png)
    </Frame>
