...
You can enable or disable athlete self-rescheduling on a per-scheduler basis. When disabled, only coaches and admins can reschedule sessions — athletes must contact you to make changes.

Configure this in your scheduler settings under **Allow Rescheduling**.

[Set up rescheduling permissions →](/scheduling/scheduler-settings-limits-and-permissions#setting-7-rescheduling-permissions)
