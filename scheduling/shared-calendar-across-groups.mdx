...
- **Resources only** — only busy time that involves a resource relevant to your group is shared. Athlete names from the other group are not shown in that busy-time view.
