...
icon: "mobile-screen"
keywords: ["share scheduler", "show on app", "athlete app", "publish scheduler", "visible to athletes", "booking link"]
---
...
## Copy a scheduler link

Where to find this: **Schedule → Schedulers**

On each scheduler card, click the chain/link icon in the top-right corner. The tooltip reads **Copy scheduler link**. Paste the link into Inbox, SMS, email, or social posts so athletes can open that scheduler directly.
...
<Steps>
  <Step title="Navigate to Athlete Portal Builder">
    ...
    ![CoachIQ athlete portal schedule page with Active toggle enabled](/images/setpageasactiveathleteportal.png)
  </Step>
  <Step title="Add your schedulers">
    ...
    ![Modal to select and add schedulers to the CoachIQ athlete portal](/images/selectschedulertoaddtoathleteportal.png)
  ...
  <Step title="Preview and publish">
    ...
    ![Live preview of scheduler booking page in the CoachIQ athlete portal](/images/Previewliveschedulerpageinathleteportal.png)
