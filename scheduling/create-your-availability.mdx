...
<Steps>
  ...
  <Step title="Create new Availabilty">
    ...
    <Frame>
      ![Availability section in scheduler builder](/images/availability-section.png)
    </Frame>
  </Step>
  <Step title="Select your available days" stepNumber={3}>
    ...
    **Example 3: Flexible Schedule**
    ...
    <Frame>
      ![CoachIQ availability schedule showing selected days with time ranges](/images/availability-ex.png)
    </Frame>
  </Step>
