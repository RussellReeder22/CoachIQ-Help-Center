...
icon: "clock"
keywords: ["availability", "how availability works", "availability template", "booking times", "open slots"]
---
...
<Tabs>
  ...
  <Tab title="What Athletes See">
    ...
    **They see**:
    ...
    - Duration (60 minutes)
    - Booking button
    - The booking calendar opened on the month of your **first available slot**, not necessarily the current month, so a scheduler whose availability starts next season does not look empty
...
<Tabs>
  ...
  <Tab title="I should create MULTIPLE availability templates when...">
    ...
    - ✅ Different session types are available at different times
    - ✅ I have distinct coaching roles (team practice vs training sessions) with separate schedules
...
<CardGroup cols={2}>
  <Card title="Create Your Availability" icon="calendar-plus" href="/scheduling/create-your-availability">
    Step-by-step guide to setting up availability templates with weekly patterns or specific dates
  </Card>
  <Card title="Understanding Schedulers" icon="sliders-h" href="/scheduling/creating-your-first-scheduler">
