...
<Info>
  **Prerequisites**: Read [Credit System Explained](/scheduling/credit-system-overview) first to understand credit concepts and types (Master Credits vs Scheduler-Specific Credits) before implementing.
</Info>
