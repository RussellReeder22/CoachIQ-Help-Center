...
icon: "gear"
keywords: ["credit setup", "credit-based booking", "accept credits", "scheduler credits", "pay with credits", "credit product"]
---

<Info>
  **Prerequisites**: Read [Credit System Explained](/payments/credits/credit-system-overview) first to understand credit concepts and types (Master Credits vs Scheduler-Specific Credits) before implementing.
</Info>
...
<Steps>
  ...
  <Step title="Test insufficient credits scenario" stepNumber={5}>
  ...
  <Step title="Test credit refund on cancellation (if setting is enabled)">
...
<CardGroup cols={3}>
  <Card title="Credit System Explained" icon="coins" href="/payments/credits/credit-system-overview">
