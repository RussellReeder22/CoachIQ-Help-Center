...
The **Schedulers** page shows these types as filter chips across the top (**All · Practices & games · Camps & events · Lessons · Rentals · Other**), so you can jump straight to the schedulers you are looking for. Athletes see the same grouping in the portal, which makes a long offering easier to browse.

## Scheduler tags

Tags are free-form labels you attach to a scheduler. Use the **TAGS** panel on the Schedulers page (**Add tag**) or the **Tags** field in the scheduler's Catalog section.
